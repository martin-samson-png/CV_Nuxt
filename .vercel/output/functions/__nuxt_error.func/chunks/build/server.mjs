...
const _routes = [
  {
    name: "avis",
    path: "/avis",
    component: () => import('./avis-ilg0548q.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Ba78CCn9.mjs')
  },
  {
    name: "start",
    path: "/start",
    component: () => import('./start-Bhontkm9.mjs')
  },
  {
    name: "contact",
    path: "/contact",
  ...
  },
  {
    name: "service",
    path: "/service",
    component: () => import('./service-EGDaaFzG.mjs')
  },
  {
    name: "infoPerso",
    path: "/infoPerso",
    component: () => import('./infoPerso-jr5WC8R1.mjs')
  },
  {
    name: "portfolio",
    path: "/portfolio",
  ...
  },
  {
    name: "companies-CV",
    path: "/companies/CV",
    component: () => import('./CV-IsA2538R.mjs')
  },
  {
    name: "companies-project",
    path: "/companies/project",
    component: () => import('./project-BT1KrSwn.mjs')
  },
  {
    name: "customers-contact",
    path: "/customers/contact",
    component: () => import('./contact-_mDTKlwX.mjs')
  },
  {
    name: "customers-project",
    path: "/customers/project",
    component: () => import('./project-3jUNKvqk.mjs')
  },
  {
    name: "customers-service",
    path: "/customers/service",
    component: () => import('./service-CN47Ppj4.mjs')
  },
  {
    name: "developers-project",
    path: "/developers/project",
    component: () => import('./project-CdfwVwvw.mjs')
  },
  {
    name: "developers-inProgress",
    path: "/developers/inProgress",
    component: () => import('./inProgress-D-TXa7d8.mjs')
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<header${ssrRenderAttrs(_attrs)} data-v-592272f3>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h1 data-v-592272f3${_scopeId}>Martin Samson</h1>`);
      } else {
        return [
          createVNode("h1", null, "Martin Samson")
        ];
      }
    }),
    _: 1
...
const Header = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-592272f3"]]), { __name: "UiHeader" });
const _sfc_main$2 = {
  __name: "app",
